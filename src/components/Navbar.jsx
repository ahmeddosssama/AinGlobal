...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center w-full mx-auto h-24">
        <Link
          to="/"
          ...
          {navLinks.map((nav) => (
            <li
              ...
              className={`underline-hover relative ${
                active === nav.title ? "active text-white font-semibold" : "text-white font-extralight"
              ...
              {navLinks.map((nav) => (
                <li
                  ...
                  className={`font-poppins font-medium cursor-pointer text-[18px] ${
                    active === nav.title ? "active text-white font-bold" : "text-secondary"
                  }`}
                  onClick={() => {
                    setToggle(!toggle);
                    setActive(nav.title);
